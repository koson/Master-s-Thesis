...
static UA_StatusCode startFindServersOnNetworkTest(){
    UA_LOG_INFO(logger,UA_LOGCATEGORY_CLIENT,"-----Starting Discovery Test-------------------");
...

    {
        ...
        UA_StatusCode retval = UA_Client_findServersOnNetwork(client, CONNECTION_STRING, 0, 0,
...
//            return (int) retval;
    ...
    {
        UA_Client *client = UA_Client_new(UA_ClientConfig_default);
        retval = UA_Client_findServers(client, CONNECTION_STRING, 0, NULL, 0, NULL,
...
//        return (int) retval;
    ...
    UA_LOG_INFO(logger,UA_LOGCATEGORY_CLIENT,"-----Ending Discovery Test-------------------");
